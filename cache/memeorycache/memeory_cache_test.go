...
func TestCacheTimes(t *testing.T) {
	...
	tc := NewMemeoryCache(50*time.Millisecond, 1*time.Millisecond)
	tc.Set("a", 1, 0)
	tc.Set("b", 2, -1)
...
func testFillAndSerialize(t *testing.T, tc *MemeoryCache) {
	tc.Set("a", "a", 0)
	tc.Set("b", "b", 0)
	tc.Set("c", "c", 0)
